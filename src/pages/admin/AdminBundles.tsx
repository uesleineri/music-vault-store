...
// working in production down to R$1; R$5 is just a sane default since a kit
// can be bought either way. create-payment enforces this too, but blocking
// it here avoids a checkout ever failing on it.
const MIN_PRICE = 5;
